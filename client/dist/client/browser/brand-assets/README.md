...
| [`agape-love-investigations-brand-logo.jpg`](agape-love-investigations-brand-logo.jpg) | **Partner logo, source** (owner-supplied) — Agape Love Investigations, the firm that runs provider background checks. NOTE: this copy is a watermarked comp ("WATERMARK" tiled across it). Replace it with the clean licensed file before launch. |
| [`agape-love-investigations-logo-web.jpg`](agape-love-investigations-logo-web.jpg) | **Partner logo, web copy** (420x228) — scaled and whitespace-trimmed from the source by [`scripts/resize-image.ps1`](../scripts/resize-image.ps1) with `-Trim`; used in the credit blurb at the bottom of the home page. Regenerate when the unwatermarked source lands. |
